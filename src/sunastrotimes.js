...
class SunAstroTimes{
    ...
    calcSolarNoon() {
        ...
        this.localDayNum = new Date(`${this.todaysDate.getMonth()+1}/${this.todaysDate.getDate()}/${this.todaysDate.getFullYear()} 12:00:00`).getTime();
        this.julianDateNow = Math.floor((this.localDayNum - dateDatum) / 86400000);
        this.meanSolarNoon = this.julianDateNow - (this.longitude / 360);
        this.solarMeanAnomaly = (357.5291 + (0.98560028 * this.meanSolarNoon)) % 360;
        ...
        this.eclipticLongitude =
            (this.solarMeanAnomaly + this.equationOfTheCentre + 180 + 102.9372) % 360;
    ...
    calcLCLMidnight(){
        this.todaysDate = new Date(this.date);
        this.localMidnight = new Date(`${this.todaysDate.getMonth()+1}/${this.todaysDate.getDate()}/${this.todaysDate.getFullYear()} 23:59:59`).getTime();
    }
    ...
    calcAstronomicalTwilight(){
        ...
        const hourAngle = deg.degACos(
            ((deg.degSin(-18 + (-1.15 * (Math.sqrt(this.altitudeFeet) / 60)))
                ...
                / (deg.degCos(this.latitude) * deg.degCos(this.solarDeclination))),
        );

        this.astronomicalTwilightRise = dateDatum + (this.solarTransit - hourAngle / 360) * 86400000;
        this.astronomicalTwilightSet = dateDatum + (this.solarTransit + hourAngle / 360) * 86400000;
    }
    calcNauticalTwilight(){
        ...
        this.nauticalTwilightRise = dateDatum + (this.solarTransit - hourAngle / 360) * 86400000;
        this.nauticalTwilightSet = dateDatum + (this.solarTransit + hourAngle / 360) * 86400000;
    }
    calcCivilTwilight(){
        ...
        this.civilTwilightRise = dateDatum + (this.solarTransit - hourAngle / 360) * 86400000;
        this.civilTwilightSet = dateDatum + (this.solarTransit + hourAngle / 360) * 86400000;
    }
    calcSunlight(){
        ...
        this.sunRise = dateDatum + (this.solarTransit - hourAngle / 360) * 86400000;
        this.sunSet = dateDatum + (this.solarTransit + hourAngle / 360) * 86400000;
    }
    calcSolarMidnight(){
